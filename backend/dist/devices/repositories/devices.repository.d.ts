...
export declare class DevicesRepository implements OnModuleInit {
    ...
    updateCameraStatus(status: 'active' | 'inactive'): import("mongoose").Query<(import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, Device, {}, import("mongoose").DefaultSchemaOptions> & Device & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    } & {
